...
const string filePath = "/Users/zong/Code/unix/DRO/载荷/test.dat";


// const string key = "EB9AC00D0200F9F9";
const string key = "352ef853";
...
vector<string> Read::readBin(string filePath, string &resTmp)
{
    ...
    ss>>resTmp;
    for(int i = 0; i < resTmp.size(); i+=16)	
    {
        binRes.push_back(resTmp.substr(i,16));
    }
    return binRes;
}
...
int main()
{
    ...
    string resTmp;
    Read test;
    result = test.readBin(filePath, resTmp);
    cout<<resTmp.size()<<endl;
